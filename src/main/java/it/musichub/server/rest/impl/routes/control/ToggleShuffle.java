...
public class ToggleShuffle extends AbstractRoute {

	@PUT
	@ApiOperation(value = "Toggle shuffle", nickname = "ToggleShuffle", tags = "control")
	@ApiImplicitParams({ //
...
//			@ApiResponse(code = 401, message = "Unauthorized", response = ApiError.class), //
	...
	public Object handle(@ApiParam(hidden = true) Request request, @ApiParam(hidden = true) Response response) throws Exception {
		...
		boolean shuffle = getUpnpControllerService().getRendererState().getPlaylist().getShuffle();
