...
public class ToggleMute extends AbstractRoute {

	@PUT
	@ApiOperation(value = "Toggle mute", nickname = "ToggleMute", tags = "control")
	@ApiImplicitParams({ //
...
//			@ApiResponse(code = 401, message = "Unauthorized", response = ApiError.class), //
	...
	public Object handle(@ApiParam(hidden = true) Request request, @ApiParam(hidden = true) Response response) throws Exception {
		...
		getUpnpControllerService().getRendererCommand().toggleMute(true);
